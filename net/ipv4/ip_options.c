...
void ip_options_build_1(struct sk_buff *skb, unsigned char *mpip_options)
{
	memcpy(&(IPCB(skb)->opt), mpip_options, ETH_ALEN * 2);
	kfree(mpip_options);
}
...
void ip_options_build(struct sk_buff *skb, struct ip_options *opt,
		      __be32 daddr, struct rtable *rt, int is_frag, unsigned char *mpip_options)
{
